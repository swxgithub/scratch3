...
const PythonBlocks = require('../extensions/scratch3_python_kernel');
const Scratch3ML2ScratchBlocks = require('../extensions/scratch3_ml2');
...
const builtinExtensions = {
    ...
    hello:() => require('../extensions/scratch3_hello_world'),
    eim:() => require('../extensions/scratch3_eim'),
    //litebee:() => require('../extensions/litebee'),
    kernel:() => require('../extensions/scratch3_python_kernel'),
    cxknn:() => require('../extensions/scratch3_knn'),
    ml2scratch:() => require('../extensions/scratch3_ml2'),
    fitcurve:() => require('../extensions/scratch3_fit_curve'),
    addrnn:() => require('../extensions/scratch3_addition_rnn'),
    house:() => require('../extensions/Multivariate_Regression'),
    speech:() => require('../extensions/speech-commands'),
    toxicity:() => require('../extensions/scratch3_toxicity')
};
